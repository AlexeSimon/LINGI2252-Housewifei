public class AutomatedTelevision extends Controller {
    ...
    String description = "Basic prototype of an automated television with 2 states. State is 0 if it is switched off, and 1 if it is switched on.";
